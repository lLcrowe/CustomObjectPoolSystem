...
namespace lLCroweTool.ClassObjectPool
{
    ...
    /// 클래스폴 타겟으로 지정할 클래스
    /// </summary>
    public class CustomClassPoolTarget
    {
    ...
    public class CustomClassPool<T> where T : CustomClassPoolTarget, new()
    {
        [Header("타겟팅될 프리팹")]
        ...
        /// </summary>
        /// <returns>프리팹</returns>
        private static T RequestClass(CustomClassPool<T> customObjectPool)
        {
            //초기화
            bool isFind = false;
            T targetObject = null;
